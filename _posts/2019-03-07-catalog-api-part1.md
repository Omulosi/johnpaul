...
In this project we are going to design a RESTFul API for a *Catalog
Application*. This will be a simple application that provides a list of items
...
* **Resource** - an object. A representation of something. It can be *created*
            *updated* or *deleted*.
...
called an *application factory* function. It returns an instance of a Flask
...
*classes*. Each class will represent a table and the associated class
